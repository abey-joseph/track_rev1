...
const _habitQuotes = <(String, String)>[
  ...
  ('Every action you take is a vote\nfor the type of person you wish to become.', 'James Clear'),
  ...
  ('The only way to break a bad habit\nis to replace it with a better one.', 'Unknown'),
  ...
  ('It is easier to prevent bad habits\nthan to break them.', 'Benjamin Franklin'),
  ('Quality is not an act, it is a habit.', 'Aristotle'),
  ('Watch your thoughts, they become your words;\nwatch your words, they become your actions;\nwatch your actions, they become your habits.', 'Lao Tzu'),
  ('Sow a thought, reap an action;\nsow an action, reap a habit;\nsow a habit, reap a character.', 'Stephen Covey'),
  ...
  ('The pain of discipline\nis far less than the pain of regret.', 'Sarah Bombell'),
  ...
  ('What saves a man is to take a step.\nThen another step.', 'Antoine de Saint-Exup\u00e9ry'),
  ...
  ('Character is the ability\nto carry out a good resolution\nlong after the excitement of the moment has passed.', 'Cavett Robert'),
